...
namespace convnet{
	...
	//private:
		inline float_tt max_In_(size_t in_index, size_t h_, size_t w_, size_t out_index){
			float_tt max_pixel = 0;
			size_t tmp;
        ...
        inline float_tt max_In_batch_(size_t batch, size_t in_index, size_t h_, size_t w_){
            float_tt max_pixel = 0;
            size_t tmp;
            for (size_t x = 0; x < 2; x++){
                for (size_t y = 0; y < 2; y++){
